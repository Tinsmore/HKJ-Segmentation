...
Label(master,text='HKJ\nChinese Word Segmentation',height=3,font=('Times',28),fg='red').grid(row=0,column=0,columnspan=3)
system=StringVar(master)
system.set('Using LQ System')
OptionMenu(master,system,'Using LQ System','Using MM System').grid(row=0,column=0,sticky=SW,padx=8)
select_system=system.get()
